#Titanic dataset is used for Classification Problem

import pandas as pd
from sklearn.preprocessing import LabelEncoder  #cat to num val.
...
df=pd.read_csv("D:/driveB/internship_23/dataset/Titanic.csv")
...
print(df.isnull().sum())
#now only the cabin feature has around 687 null values....So, we have to drop that feature
...
#-----numerical to categorical values using LabelEncoder-----
le = LabelEncoder()
le.fit(X['Sex'])
